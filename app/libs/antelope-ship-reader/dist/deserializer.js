...
export function deserializeAbieos({ code, data, type }) {
...
export function deserializeEosjs({ type, data, types }) {
...
function processDeserializationRequest({ code, data, type, table, action }) {
    ...
    if (args.ds_experimental) {
        ...
        const deserializationTypes = Serialize.getTypesFromAbi(Serialize.createInitialTypes(), deserializationAbi);
