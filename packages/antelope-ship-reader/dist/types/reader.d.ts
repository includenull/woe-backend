...
export declare type EosioReaderState = {
...
export declare type EosioReaderAbisMap = Map<string, RpcInterfaces.Abi>;
...
export interface EosioReaderBlock {
    ...
    table_rows: EosioReaderTableRow[];
    abis: any[];
}
...
export interface EosioReaderAction<T = {
    [key: string]: any;
} | string> {
    transaction_id: string;
    account: string;
